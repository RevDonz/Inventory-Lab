                                            ...
                                            <TableRow key={i}>
                                                ...
                                                <TableCell>
                                                    <div className="flex items-center space-x-4">
                                                        <Button layout="link" icon={EditIcon} aria-label="Edit" />
                                                        <Button className="text-red-500" layout="link" icon={TrashIcon} aria-label="Delete" onClick={() => handleDeletePost(item._id)} />
                                                    </div>
                                                </TableCell>
                                            </TableRow>
                                        )
