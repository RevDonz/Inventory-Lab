...
const Register = () => {
  ...
  return (
    <div className="bg-blue-100">
      ...
      <div className="-mt-96 w-">
        <div className="items-center justify-center w-9/12 text-center m-auto">
          <h1 className="text-5xl md:text-7xl pb-10 text-blue-500 font-normal">Registrasi</h1>
        </div>
        <div className="w-full pt-11 text-lg">
          <form onSubmit={onSubmit}>
            <div className="mx-10 items-center justify-center text-center">
              <input className="w-full py-3 md:py-3 md:w-3/5 focus:ring-blue-300 focus:border-blue-300 border-1 border-blue-200 rounded-lg my-4" type="text" name="fullname" placeholder="Nama Lengkap" 
              value={fullname} onChange={(e) => setFullname(e.target.value)}/> <br/>
              <input className="w-full py-3 md:py-3 md:w-3/5 focus:ring-blue-300 focus:border-blue-300 border-1 border-blue-200 rounded-lg my-4" type="text" name="NIM" placeholder="Nomor Induk Mahasiswa / NIM" 
              value={NIM} onChange={(e) => setNIM(e.target.value)}/> <br/>
              <input className="w-full py-3 md:py-3 md:w-1/5 focus:ring-blue-300 focus:border-blue-300 border-1 border-blue-200 rounded-lg md:rounded-r-none my-4" type="text" name="major" placeholder="Jurusan"
              value={major} onChange={(e) => setMajor(e.target.value)}/>
              <input className="w-full py-3 md:py-3 md:w-1/5 focus:ring-blue-300 focus:border-blue-300 border-1 border-blue-200 rounded-lg md:rounded-none my-4" type="text" name="faculty" placeholder="Fakultas"
              value={faculty} onChange={(e) => setFaculty(e.target.value)}/>
              <input className="w-full py-3 md:py-3 md:w-1/5 focus:ring-blue-300 focus:border-blue-300 border-1 border-blue-200 rounded-lg md:rounded-l-none my-4" type="text" name="year" placeholder="Angkatan"
              value={year} onChange={(e) => setYear(e.target.value)}/> <br/>
              <input className="w-full py-3 md:py-3 md:w-3/5 focus:ring-blue-300 focus:border-blue-300 border-1 border-blue-200 rounded-lg my-4" type="number" name="phoneNumber" placeholder="Nomor Handphone"
              value={phoneNumber} onChange={(e) => setPhoneNumber(e.target.value)}/> <br/>
              <input className="w-full py-3 md:py-3 md:w-3/5 focus:ring-blue-300 focus:border-blue-300 border-1 border-blue-200 rounded-lg my-4" type="text" name="homeAddress" placeholder="Alamat"
              value={homeAddress} onChange={(e) => setHomeAddress(e.target.value)}/> <br/>
              <input className="w-full py-3 md:py-3 md:w-3/5 focus:ring-blue-300 focus:border-blue-300 border-1 border-blue-200 rounded-lg my-4" type="email" name="email" placeholder="E-mail"
              value={email} onChange={(e) => setEmail(e.target.value)}/> <br/>
              <input className="w-full py-3 md:py-3 md:w-3/5 focus:ring-blue-300 focus:border-blue-300 border-1 border-blue-200 rounded-lg my-4" type="password" name="password" placeholder="Kata Sandi"
              value={password} onChange={(e) => setPassword(e.target.value)}/> <br/>
              <input className="w-full py-3 md:py-3 md:w-3/5 focus:ring-blue-300 focus:border-blue-300 border-1 border-blue-200 rounded-lg my-4" type="password" name="confirmPass" placeholder="Konfirmasi Kata Sandi"/> <br/>
            </div>
            <div className="px-10 md:w-3/5 m-auto pt-9">
              ...
              <label className="inline-flex items-center mt-4" >
                ...
                <span className="ml-4 text-blue-400 text-base md:text-lg">Saya Telah Membaca dan Menyetujui Persyaratan Layanan</span> 
              </label>
            </div>
            <div className="items-center text-center mt-16 pb-20 md:pb-0">
              <button className="bg-blue-300 text-white-100 rounded-lg px-20 py-4 text-2xl shadow-2xl">Daftar</button>
            </div>
          </form>
        </div>
      </div>
