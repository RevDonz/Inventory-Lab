...
const UpdateItem = (props) => {
    ...
    useEffect(() => {  
        ...
        .then(res => {
            ...
            setCurrentItem(data.itemAmount);
    ...
    const onSubmit = (event) => {
        ...
        if (itemAmount > currentItem) {
            const tambah = itemAmount - currentItem
        ...
        } else if (itemAmount < currentItem) {
            const kurang = currentItem - itemAmount;
            // setItemAmount(kurang)
            console.log("ngurang");
            const stok = new URLSearchParams();
            stok.append('itemAmount', itemAmount);

            // const jml = props.match.params.kurang
                    ...
                    <form action=''>
                        <div className='gap-4 space-y-3'>
                            ...
                            <Label>
                                ...
                                {itemPicture && <img className="w-12 h-14" src={preview} alt={itemAmount}></img>}
                            <Label>
